...
if (isset($_SESSION['clientenombre']) && isset($_SESSION['clienteemail']) && isset($_SESSION['idcliente'])) {
    echo '<strong>Nombre del Cliente:</strong> ' . htmlspecialchars($_SESSION['clientenombre']) . '<br>';
    echo '<strong>Email del Cliente:</strong> ' . htmlspecialchars($_SESSION['clienteemail']) . '<br>';
} else {
...
<!-- Seccion para reservar una mesa -->
<div class="">
    <div class="container-fluid has-bg-overlay text-center text-light has-height-lg middle-items" id="reserva">
        <div>
            <h2 class="section-title mb-5">RESERVA TU MESA</h2>

            <div class="row mb-4">
                <div class="col-md-5 mx-auto">
                    <div class="card bg-transparent border">
                        <img src="../public_html/assets/imgs/plan-de-asientos.jpg" alt="Elige tu lugar ideal (Plan de asientos)">
                    </div>
                </div>
            </div>

            <form method="post" name="reservaForm" id="reservaForm">
                <div class="container text-center mt-5">
                    <a href="../google/google.php" class="main__link">
                        <img src="../img/google-icon.svg" class="main__icon">
                        <i class="bx bx-save"></i> REGISTRATE
                    </a>
                </div>
                <div class="row mb-5">
                    <div class="col-sm-6 col-md-3 col-xs-12 my-2">
                        <input type="number" class="form-control form-control-lg custom-form-control" placeholder="NRO DE COMENSALES" min="0" max="6" id="num_comensales" name="num_comensales" required>
                    </div>
                    <div class="col-sm-6 col-md-3 col-xs-12 my-2">
                        <input type="time" class="form-control form-control-lg custom-form-control" placeholder="HORA" maxlength="500" id="reservahora" min="09:00:00" max="23:00:00" name="reservahora" required>
                    </div>
                    <div class="col-sm-6 col-md-3 col-xs-12 my-2">
                        <input type="date" class="form-control form-control-lg custom-form-control" placeholder="FECHA" maxlength="500" min="2024-06-01" max="2024-12-31" id="reservafecha" name="reservafecha" required>
                    </div>
                    <div class="col-sm-6 col-md-3 col-xs-12 my-2">
                        <select class="form-control form-control-lg custom-form-control" id="mostrarmesa" name="num_mesa" required>

                        </select>
                    </div>
                </div>
            </form>
            <button class="btn btn-lg btn-primary" onclick="guardaryeditarreserva()" type="submit" id="btnGuardarreserva">
                <i class="bx bx-save"></i> Finalizar Reserva
            </button>
        </div>
    </div>
</div>
