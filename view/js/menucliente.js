...
function initMenu(){
	...
	$('#tipo').validacion(' abcdefghijklmnñopqrstuvwxyzáéíóú');
    $('#precio').validacion(' abcdefghijklmnñopqrstuvwxyzáéíóú');
...
function listarMenu() {
    $.ajax({
        url: '../src/menu.php?op=6',
        type: 'get',
        dataType: 'json',
        success: function(data) {
            var container = $('#card');
            container.empty(); // Limpiamos el contenedor antes de agregar nuevas tarjetas
...
/*$(document).ready(function() {
    $("#a").on("submit", guardaryeditarMenu);
});*/
