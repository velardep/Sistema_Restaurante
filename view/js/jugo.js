                    ...
                    <div class="col-md-4">
                        <div class="card bg-transparent border my-3 my-md-0">
                            ...
                            <div class="card-body">
                                ...
                                <button class="btn btn-info" onclick="mostrarJugo(${item.id})"><i class="bx bx-pencil"></i>Editar</button>
                                ${item.condicion ?
                                    `<button class="btn btn-primary" onclick="desactivarJugo(${item.id})"><i class="bx bx-trash"></i>Desactivar</button>` : 
                                    `<button class="btn btn-danger" onclick="activarJugo(${item.id})"><i class="bx bxs-check-square"></i>Activar</button>`}
                            </div>
                        </div>
                    </div>`;
